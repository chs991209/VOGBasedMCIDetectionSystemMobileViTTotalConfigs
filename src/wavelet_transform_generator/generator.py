...
CLI examples:
    ...
    python src/wavelet_transform_generator/generator.py --trials 3

    # Render from the legacy cache instead:
    python src/wavelet_transform_generator/generator.py \\
...
logger = logging.getLogger("wavelet_transform_generator")
